...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    TNDProductDetailsViewController *productDetailsViewController = [TNDProductDetailsViewController new];
    [productDetailsViewController setProduct:products[indexPath.row]];
